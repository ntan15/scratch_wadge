...
\end{align*} 
Figure~\ref{fig:converge3d} shows $L^2$ errors for $N = 2,3,4$ on both affine and curved meshes.  
\begin{figure}
\centering
\begin{tikzpicture}
\begin{loglogaxis}[
...
\end{loglogaxis}
\end{tikzpicture}
\caption{Convergence of $L^2$ errors for the 3D isentropic vortex problem on affine and curved meshes.}
