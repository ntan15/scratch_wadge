...
\]
where $\bm{G}^k$ is the matrix of unscaled geometric terms for $D^k$.  Then, a scaling argument \cite{ciarlet1978finite, brenner2007mathematical} yields
\begin{align}
...
J^k\bm{G}^k_{1i}\\
J^k\bm{G}^k_{2i}\\
J^k\bm{G}^k_{3i}\end{array}} =
\LRs{\begin{array}{c}
    \left(         - \nabla_{\hat{\bm{x}}} \times \left(x_3 \nabla_{\hat{\bm{x}}} x_2\right)\right)_i\\
    \left(\phantom{-}\nabla_{\hat{\bm{x}}} \times \left(x_3 \nabla_{\hat{\bm{x}}} x_1\right)\right)_i\\
    \left(\phantom{-}\nabla_{\hat{\bm{x}}} \times \left(x_1 \nabla_{\hat{\bm{x}}} x_2\right)\right)_i\end{array}},
\label{eq:conscurl}
\end{align}
...
J^k\bm{G}^k_{3i}\end{array}} =
\LRs{\begin{array}{c}
    \left(         - \nabla_{\hat{\bm{x}}} \times I_N\left(x_3 \nabla_{\hat{\bm{x}}} x_2\right)\right)_i\\
    \left(\phantom{-}\nabla_{\hat{\bm{x}}} \times I_N\left(x_3 \nabla_{\hat{\bm{x}}} x_1\right)\right)_i\\
    \left(\phantom{-}\nabla_{\hat{\bm{x}}} \times I_N\left(x_1 \nabla_{\hat{\bm{x}}} x_2\right)\right)_i\end{array}},
\label{eq:iconscurl}
\end{align}
...
J^k\bm{G}^k_{3i}\end{array}} =
\LRs{\begin{array}{c}
    I_N\left(         - \nabla_{\hat{\bm{x}}} \times I_{N+1}\left(x_3 \nabla_{\hat{\bm{x}}} x_2\right)\right)_i\\
    I_N\left(\phantom{-}\nabla_{\hat{\bm{x}}} \times I_{N+1}\left(x_3 \nabla_{\hat{\bm{x}}} x_1\right)\right)_i\\
    I_N\left(\phantom{-}\nabla_{\hat{\bm{x}}} \times I_{N+1}\left(x_1 \nabla_{\hat{\bm{x}}} x_2\right)\right)_i\end{array}}.
\label{eq:iconscurl2}
\end{align}
