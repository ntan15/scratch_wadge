...
Similar to what is done in finite difference discretizations~\cite{nordstrom2006cfdf}, we define physical differentiation matrices based on the approximation of (\ref{eq:splitderiv}).  Define $\bm{D}^i_k$ as 
\[
