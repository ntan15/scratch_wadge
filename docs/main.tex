...
\newcommand{\note}[1]{{\color{blue}{#1}}}
\newcommand{\lcwnote}[1]{{\color{gray}{LCW: #1}}}
...
\bm{D}_N^i =\LRs{
\begin{array}{cc}
\bm{V}_q\bm{D}_i \bm{P}_q - \frac{1}{2}\bm{V}_q\bm{L}_q {\rm diag}\LRp{\hat{\bm{n}}_i\circ\bm{\hat{J}}_f}\bm{V}_f\bm{P}_q & \frac{1}{2}\bm{V}_q\bm{L}_q  {\rm diag}\LRp{\hat{\bm{n}}_i\circ\bm{\hat{J}}_f}\\
- \frac{1}{2}{\rm diag}\LRp{\hat{\bm{n}}_i\circ\bm{\hat{J}}_f} \bm{V}_f\bm{P}_q &  \frac{1}{2}{\rm diag}\LRp{\hat{\bm{n}}_i\circ\bm{\hat{J}}_f}
\end{array}
}
