...
We note that the error in both approximations of $\tilde{J^k\bm{G}^k_{ij}}$ converge as $O(h^{N+1})$, the same rate as the $L^2$ projection error.  
Sensititivity to geometry error \cite{toulorge2016optimizing}. 
