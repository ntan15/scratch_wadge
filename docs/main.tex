...
%The choice of $\Theta$ is adaptively guided by the pointwise change in entropy between $S(\bm{u}_v)$ and $S(\bm{u})$.  We can use the fact that $S(\bm{u})$ is convex, such that
%\[
